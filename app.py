    ...
    with formcol1:
        ...
        with form_place.container():
            ...
            with st.expander("Form",expanded=True):
                ...
                for i in st.session_state.items_order:
                        st.session_state.answers.append(st.radio(st.session_state.mist_items[i], st.session_state.order, key = "q"+str(i+1), format_func=format, label_visibility="visible", horizontal=True))
